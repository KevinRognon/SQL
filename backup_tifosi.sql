...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 05 oct. 2023 à 18:21
...
(1, 'Kevin Rognon', 25, 60250),
(2, 'Alice Dupont', 28, 75001),
(3, 'Pierre Martin', 35, 69002),
(4, 'Sophie Lambert', 22, 33000),
(5, 'Élise Dubois', 29, 13001),
(6, 'Thomas Lefebvre', 31, 59000),
(7, 'Marie Renaud', 27, 69003);
...
(1, 'Menu Mozaccia', 12.5, 1),
(2, 'Menu Gorgonzollaccia', 13.5, 2),
(3, 'Menu Raclaccia', 11.6, 3),
(4, 'Menu Emmentalaccia', 12.5, 4),
(5, 'Menu Tradizione', 11.6, 5),
(6, 'Menu Hawaienne', 14, 6),
(7, 'Menu Américaine', 13.5, 7),
(8, 'Menu Paysanne', 15.5, 8);
